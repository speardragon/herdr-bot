...
export const translations: Record<string, string> = {
  ...
  "Connecting to your computer…": "herdr에 연결하는 중…",
  "Can’t reach your computer": "herdr에 연결할 수 없습니다",
  ...
  "Rename Bot": "Bot 이름 변경", "Rename group": "그룹 이름 변경", "Edit Profile": "프로필 편집",
  ...
  "New": "새로 만들기", "New chat": "새 채팅", "Bot": "봇", "Room": "방", "Name": "이름",
  "Search or create a Bot": "Bot 검색 또는 생성", "Create a new Bot": "새 Bot 만들기",
  "Create a group chat": "그룹 채팅 만들기", "Start chat": "채팅 시작", "To:": "받는 사람:",
  "Setting up this bot…": "이 봇을 설정하는 중…", "Bot setup failed": "봇 설정 실패",
  "This bot could not be set up.": "이 봇을 설정하지 못했습니다.",
  "That bot is no longer available.": "해당 봇을 더 이상 사용할 수 없습니다.",
  ...
  "All": "전체", "Messages": "메시지", "Bots": "Bot", "Groups": "그룹", "Files": "파일", "Links": "링크", "Routines": "루틴", "Actions": "작업",
  "Current chat": "현재 채팅", "Chat Settings": "채팅 설정", "Channels": "채널", "Settings: General": "설정", "No results": "결과 없음",
  "Current": "현재", "Sidebar": "사이드바", "Group settings": "그룹 설정",
  "Label (optional)": "레이블 (선택사항)", "Research, marketing, admin": "리서치, 마케팅, 관리", "Group name": "그룹 이름", "What this group is for": "이 그룹의 역할", "Filter results": "결과 필터", "Results": "결과", "Search unavailable": "검색을 사용할 수 없음", "Try again in a moment.": "잠시 후 다시 시도해 주세요.",
  "Search messages": "메시지 검색", "Type to find messages across your chats.": "입력하면 모든 채팅에서 메시지를 찾습니다.",
  "No group chats yet": "그룹 채팅이 없습니다", "No files yet": "파일이 없습니다", "No links in this chat yet": "이 채팅에는 링크가 없습니다",
  "No routines yet": "루틴이 없습니다", "No actions": "작업이 없습니다", "No agents yet": "봇이 없습니다", "Back": "뒤로",
  ...
  "Attach file": "파일 첨부", "Send message": "메시지 보내기", "Voice input is not available yet": "음성 입력은 아직 지원되지 않습니다", "Mention": "봇 멘션",
  "Nothing to mention yet": "멘션할 봇이 없습니다", "Search": "검색", "Delete": "삭제", "Rename": "이름 변경",
  "Copy ID": "ID 복사", "Working": "작업 중",
  "Needs attention": "확인 필요", "Unread activity": "읽지 않은 활동", "Load older messages": "이전 메시지 보기", "Loading…": "불러오는 중…", "Retry": "다시 시도",
